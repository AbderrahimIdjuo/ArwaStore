...
export default function Home() {
  ...
  const handleOpenAddClient = () =>
    setOpen((cur) => ({ ...cur, addClientDialog: !cur.addClientDialog }));
  const handleOpenAddOrder = () =>
    setOpen((cur) => ({ ...cur, addOrderDialog: !cur.addOrderDialog }));
  const handleOpenAddCompta = () =>
    setOpen((cur) => ({ ...cur, addComptaDialog: !cur.addComptaDialog }));
