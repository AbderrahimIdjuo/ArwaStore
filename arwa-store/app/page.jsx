...
import { Input, Typography, Checkbox, Button } from "@/app/MT";
      ...
      <Container className="flex flex-row justify-center">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            <div className="p-3 rounded-full bg-[#e1f5fe] ">
              <ShoppingBagIcon className="w-10 h-10 text-[#0091ea]" />
            </div>
            <h1 className="text-2xl font-bold tracking-tight">ARWA STORE</h1>
          ...
          <div>
            <div className="relative mt-5">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#FFFFFF] px-2 ">Or continue with</span>
              </div>
            </div>
